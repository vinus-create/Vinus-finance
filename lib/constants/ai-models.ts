...
export const MODELS = [
  { id: 'gemini-3.1-flash-lite', label: 'Gemini Flash Lite 3.1', desc: 'Newest lite. Fastest & cheapest, best for text/PDF parsing.' },
  { id: 'gemini-3.5-flash', label: 'Gemini Flash 3.5', desc: 'Newest stable Flash. Highest quality for voice audio & receipt images.' },
